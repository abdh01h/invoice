						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">Invoices List</h4>
									<div class="btn-icon-list btn-list">
                                        @can('export-invoices')
                                        <a href="{{ route('invoices.excel.all') }}" class="btn btn-icon  btn-success" data-placement="top" data-toggle="tooltip" title="Export as Excel">
                                                    ...
                                                    <td>
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdown">
                                                                ...
                                                                @endcan
                                                                @can('print-invoices')
                                                                <a href="{{ route('invoice.print', $invoice) }}" class="dropdown-item">
